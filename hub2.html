...
<head>
  ...
  <style>
    * {
    ...
    #restart, #rps-restart, #guess-restart {
      margin-top: 10px;
      padding: 10px 20px;
      font-size: 16px;
      border: none;
    ...
    #restart:hover, #rps-restart:hover, #guess-restart:hover {
...
<body>
  ...
  <nav>
    ...
    <button onclick="switchGame('guess')">Guess the Number</button>
  </nav>
  ...
  <div id="guess" class="game-container">
    ...
    <button id="guess-restart" onclick="resetGuessGame()">Restart</button>
  </div>
